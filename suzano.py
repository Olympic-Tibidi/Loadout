        ...
        if select=="ADMIN" :
            ...
            with admin_tab1:
                ...
                with release_order_tab1:
                    ...
                    quantity=st.number_input("Quantity of Units", min_value=1, max_value=1500, value=1, step=1,  key=None, help=None, on_change=None, disabled=False, label_visibility="visible")
                    tonnage=2*quantity
