    ...
    if len(dispatched.keys())>0 and not no_dispatch:
        ...
        with col3: 
            ...
            if st.button("GENERATE BILL OF LADING"):
                ...
                bill_of_ladings[str(number)]:{"vessel":vessel,"release_order":release_order_number,"sales_order":sales_order_item,"carrier_id":carrier_code,"vehicle":vehicle_id,"quantity":quantity}
