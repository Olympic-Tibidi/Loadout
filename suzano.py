        ...
        if select=="ADMIN" :
            ...
            with admin_tab1:
                ...
                with release_order_tab1:
                    ...
                    admt=st.text_input("ADMT PER UNIT",round(int(batch_mapping[ocean_bill_of_lading]["dryness"])/90,2),disabled=True)
                    ...
                    with rls_tab1:
                       ...
                       # files_in_folder=[i for i in files_in_folder if i not in junk.keys()]
                        ...
                        if nofile!=1 :         
                            ...
                            hangisi=st.selectbox("**:green[SELECT SALES ORDER ITEM TO DISPATCH]**",([i for i in target if i not in sales_orders_completed]))
