            ...
            with admin_tab1:
                ...
                with release_order_tab2:
                    ...
                    with rls_tab3:
                        ...
                        destinations_of_release_orders=[f"{i} to {release_order_dest_map[i]}" for i in files_in_folder]# if release_order_database[i]["001"]["destination"] in ["GP-Clatskanie,OR","GP-Halsey,OR"] and release_order_database[i]["001"]["remaining"]>2 in files_in_folder]
