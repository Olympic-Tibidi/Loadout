...
def process():
    ...
    if double_load:
        ...
        for k in loads:
            loadls.append("2DEV:"+release_order_number+" "*(10-len(release_order_number))+"000"+sales_order_item+a+tsn+k[:-3]+" "*(10-len(k[:-3]))+"0"*16+str(quantity*2000))
        ...
        if select=="LOADOUT" :
            ...
            if len(dispatched.keys())>0 and not no_dispatch:
                ...
                with load_col1:
                    ...
                    temp5={"<b>Total Tonnage":int(real_quant*2+ship_bale*2/8,"<b>Shipped Tonnage":ship_*2,"<b>Remaining Tonnage":quant_*2-(ship_*2)}
