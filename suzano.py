...
def process():
    ...
    if double_load:
        ...
        for k in loads:
            loadls.append("2DEV:"+release_order_number+" "*(10-len(release_order_number))+"000"+sales_order_item+a+tsn+k+" "*(10-len(k))+"0"*(16-len(str(int(loads[k]*2000))))+str(int(loads[k]*2000)))
